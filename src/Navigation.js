...
const ScheduleNavigation = TabNavigator(
  {
    Monday: {
      screen: Screens.ScheduleDay({ day: 'Monday', date: '23' }),
    },
    Tuesday: {
      screen: Screens.ScheduleDay({ day: 'Tuesday', date: '24' }),
    },
    Wednesday: {
      screen: Screens.ScheduleDay({ day: 'Wednesday', date: '25' }),
    },
    Thursday: {
      screen: Screens.ScheduleDay({ day: 'Thursday', date: '26' }),
    },
    Friday: {
      screen: Screens.ScheduleDay({ day: 'Friday', date: '27' }),
    },
  },
  {
    lazy: true,
...
const OrganisationNavigation = StackNavigator(
  {
    OrganisationList: {
      screen: Screens.Organisations,
    },
  },
  DefaultStackConfig
);
...
const DrawerRouteConfig = {
  ...
  Organisations: { screen: OrganisationNavigation },
};
      ...
      <View style={styles.drawerContainer}>
        <View style={styles.drawerHeader}>
          ...
          <View
            style={[
              ...
              { backgroundColor: 'rgba(29, 175, 236, 0.57)' },
            ]}
          />
          <View
            style={[
        ...
        <View style={styles.drawerButtons}>
          ...
          {this._renderButtons([
            ...
            { route: 'Organisations', title: 'Organisations' },
          ])}
        </View>
      </View>
    );
